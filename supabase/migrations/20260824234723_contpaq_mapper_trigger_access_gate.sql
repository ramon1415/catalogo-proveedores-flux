-- Flux Operadora — el trigger debe fallar por autorización antes de consultar
-- el catálogo. En PostgreSQL un BEFORE INSERT puede ejecutarse antes del WITH CHECK
-- de RLS; sin este gate Dirección recibía un error de dominio engañoso.
