-- PROD hotfix: Yanin comparte exactamente las partidas activas de Lis en
...
begin
  ...
  join public.company_cost_center_budget_category_responsibles target
    on target.company_id = source.company_id
   and target.cost_center_id = source.cost_center_id
   and target.budget_category_id = source.budget_category_id
   and target.responsible_email = 'ynavarrete@soportef.com'
