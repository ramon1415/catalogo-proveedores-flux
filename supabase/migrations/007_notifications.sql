...
-- PostgreSQL can grant EXECUTE to PUBLIC by default for newly-created functions.
-- Revoke broad/default access first, then add only the explicit roles needed.

revoke execute on function public."claim_pending_notification_events"(integer, text) from PUBLIC;
revoke execute on function public."claim_pending_notification_events"(integer, text) from anon;
revoke execute on function public."claim_pending_notification_events"(integer, text) from authenticated;
...
revoke execute on function public."enqueue_notification_event"(text, text, uuid, text, text, uuid, text, text, jsonb, text, text) from PUBLIC;
revoke execute on function public."enqueue_notification_event"(text, text, uuid, text, text, uuid, text, text, jsonb, text, text) from anon;
revoke execute on function public."enqueue_notification_event"(text, text, uuid, text, text, uuid, text, text, jsonb, text, text) from authenticated;
...
revoke execute on function public."enqueue_notification_event_internal"(text, text, uuid, text, text, uuid, text, text, jsonb, text, text) from PUBLIC;
revoke execute on function public."enqueue_notification_event_internal"(text, text, uuid, text, text, uuid, text, text, jsonb, text, text) from anon;
revoke execute on function public."enqueue_notification_event_internal"(text, text, uuid, text, text, uuid, text, text, jsonb, text, text) from authenticated;
...
revoke execute on function public."mark_notification_failed"(uuid, text, text, text) from PUBLIC;
revoke execute on function public."mark_notification_failed"(uuid, text, text, text) from anon;
revoke execute on function public."mark_notification_failed"(uuid, text, text, text) from authenticated;
...
revoke execute on function public."mark_notification_processed"(uuid, text, text, text) from PUBLIC;
revoke execute on function public."mark_notification_processed"(uuid, text, text, text) from anon;
revoke execute on function public."mark_notification_processed"(uuid, text, text, text) from authenticated;
...
revoke execute on function public."notification_current_profile_id"() from PUBLIC;
revoke execute on function public."notification_current_profile_id"() from anon;
revoke execute on function public."notification_current_profile_id"() from authenticated;
...
revoke execute on function public."notification_current_user_has_role"(text[]) from PUBLIC;
revoke execute on function public."notification_current_user_has_role"(text[]) from anon;
revoke execute on function public."notification_current_user_has_role"(text[]) from authenticated;
...
revoke execute on function public."set_updated_at_notification_events"() from PUBLIC;
revoke execute on function public."set_updated_at_notification_events"() from anon;
revoke execute on function public."set_updated_at_notification_events"() from authenticated;
