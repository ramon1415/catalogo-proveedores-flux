...
-- No se concede UPDATE/DELETE al cliente: cada ingestión es evidencia inmutable.
...
comment on table public.payment_request_cfdi_facts is
  'FB-2: evidencia fiscal normalizada del CFDI adjunto a una solicitud. Sin Tax Resolver ni cuentas CONTPAQ.';
