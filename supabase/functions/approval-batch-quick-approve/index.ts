const DEV_ORIGIN = "https://catalogo-proveedores-flux-git-dev-quantta-team.vercel.app";
...
export async function handleRequest(req: Request, runtime: Runtime) {
  ...
  if (origin && origin !== DEV_ORIGIN) return jsonResponse({ state: "invalid" }, 403, origin);
