-- Flux Operadora - Migration 015
-- Disable legacy direct payment notification enqueue routes.
-- Replaces business RPCs with the clean trigger-only notification versions.
