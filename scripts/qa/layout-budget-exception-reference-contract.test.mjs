...
test("cache busters deliver every changed browser asset", () => {
  assert.match(config, /solicitudes_workboard_extension\.js\?v=20260817-budget-exception-layout/)
  assert.match(solicitudesHtml, /config\.js\?v=20260817-budget-exception-layout/)
