...
Backport de #689 a producción, tarea `86bc728hh` (auditoría #687).
La base de producción tiene 152 advertencias; DEV tiene 159. Cada rama mantiene
su límite medido, sin incorporar otros módulos pendientes de DEV. ESLint revisa `src/`
...
- `--max-warnings 152` bloquea un aumento del **total** de advertencias. Es un
...
Medición inicial sobre `main` `43f72a1`, con esta configuración (24-sep-2026):
...
esa limpieza corresponde a `86bc728pg`. Los 10 hallazgos de efectos necesitan
