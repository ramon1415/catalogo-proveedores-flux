...
const INTAKE_ERROR_MESSAGES: Record<string, string> = {
  ...
  provider_intake_conversion_draft_fields_required: 'Faltan datos de control. Pulsa «Recargar borrador» y vuelve a revisar la preparación.',
  provider_intake_conversion_draft_status_invalid: 'La solicitud ya no está en revisión; el borrador quedó en modo de solo lectura.',
  provider_intake_conversion_draft_already_converted: 'La solicitud de pago definitiva ya fue creada.',
  provider_intake_conversion_draft_intake_conflict: 'La solicitud cambió después de abrir esta preparación. Pulsa «Recargar borrador», revisa los datos y vuelve a guardarlo.',
  provider_intake_conversion_draft_conflict: 'Otra persona actualizó el borrador. Pulsa «Recargar borrador» para revisar la versión vigente.',
  provider_intake_conversion_draft_action_actor_conflict: 'La acción pertenece a otra sesión. Pulsa «Recargar borrador» antes de continuar.',
  provider_intake_conversion_draft_action_material_conflict: 'La preparación cambió después de iniciar la acción. Pulsa «Recargar borrador» antes de continuar.',
  provider_intake_conversion_draft_cost_center_invalid: 'El centro de costo no pertenece a la empresa o está inactivo. Selecciona uno vigente.',
  provider_intake_conversion_draft_budget_category_invalid: 'La categoría no está autorizada para el centro de costo seleccionado.',
  provider_intake_conversion_draft_budget_month_invalid: 'Selecciona un mes presupuestal válido.',
  provider_intake_conversion_draft_origin_account_invalid: 'La cuenta origen no pertenece a la empresa o está inactiva.',
  provider_intake_conversion_draft_origin_account_not_allowed: 'La cuenta origen solamente aplica cuando el método de pago es Transferencia.',
  provider_intake_conversion_draft_payment_method_invalid: 'Selecciona un método de pago permitido.',
  provider_intake_conversion_draft_requester_invalid: 'El solicitante seleccionado ya no está autorizado.',
  provider_intake_conversion_draft_requester_company_invalid: 'El solicitante no tiene membresía activa en esta empresa.',
  provider_intake_conversion_draft_approver_invalid: 'El aprobador ya no es una opción permitida. Recarga el borrador y selecciona uno vigente.',
  ...
  provider_intake_conversion_draft_notes_invalid: 'Las notas internas contienen texto no permitido o exceden 2000 caracteres.',
  provider_intake_conversion_draft_amount_reason_invalid: 'El motivo del cambio debe tener entre 10 y 1000 caracteres válidos.',
  provider_intake_conversion_draft_amount_reason_required: 'Explica el cambio de monto en al menos 10 caracteres.',
  provider_intake_conversion_fields_required: 'Faltan datos de control. Pulsa «Recargar borrador» antes de convertir.',
  provider_intake_conversion_status_invalid: 'La solicitud ya no está en revisión y no puede convertirse.',
  provider_intake_conversion_intake_conflict: 'La solicitud cambió después de abrir esta preparación. Pulsa «Recargar borrador» antes de convertir.',
  provider_intake_conversion_draft_required: 'Primero guarda un borrador completo antes de convertir.',
  provider_intake_conversion_not_ready: 'La preparación ya no está lista para convertirse. Recarga el borrador y revisa los campos pendientes.',
  provider_intake_conversion_provider_required: 'Confirma un proveedor maestro antes de convertir.',
  provider_intake_conversion_provider_inactive: 'El proveedor maestro está inactivo. Selecciona un proveedor vigente.',
  provider_intake_conversion_cost_center_invalid: 'El centro de costo ya no está disponible para esta empresa.',
  ...
  provider_intake_conversion_origin_account_not_allowed: 'La cuenta origen solamente aplica cuando el método de pago es Transferencia.',
  provider_intake_conversion_requester_invalid: 'El solicitante interno ya no es válido.',
  provider_intake_conversion_requester_company_invalid: 'El solicitante perdió acceso a esta empresa.',
  provider_intake_conversion_approver_invalid: 'Las reglas de aprobación cambiaron. Recarga el borrador y selecciona un aprobador vigente.',
  ...
  provider_intake_conversion_link_invalid: 'La liga con la solicitud creada es inconsistente. Recarga el detalle.',
  provider_intake_conversion_link_conflict: 'Otra conversión terminó primero. Recarga el detalle para abrir la solicitud creada.',
  provider_intake_conversion_request_create_failed: 'No fue posible crear la solicitud de pago. Revisa los datos e inténtalo nuevamente.',
  provider_intake_banking_resolution_fields_required: 'Recarga el borrador antes de confirmar los datos bancarios maestros.',
  provider_intake_banking_resolution_status_invalid: 'El estado actual ya no permite resolver los datos bancarios.',
  provider_intake_banking_resolution_intake_conflict: 'La solicitud cambió. Recarga el borrador antes de confirmar los datos bancarios.',
  provider_intake_banking_resolution_provider_required: 'Confirma un proveedor maestro antes de resolver los datos bancarios.',
  provider_intake_banking_resolution_provider_conflict: 'El proveedor maestro cambió. Recarga y vuelve a comparar.',
  provider_intake_banking_resolution_transfer_required: 'Guarda primero el borrador con método de pago Transferencia.',
  provider_intake_banking_resolution_not_required: 'Los datos bancarios ya no presentan una diferencia que requiera revisión.',
...
export function friendlyIntakeError(error: unknown): string {
  ...
  if (message.includes('provider_intake_')) {
    return 'No fue posible completar la operación porque la solicitud cambió o dejó de cumplir una regla. Recarga el detalle y vuelve a intentarlo.'
  }
