-- Flux Operadora - DEV ops load for migration 004b
-- Source migration: supabase/migrations/004b_payment_receipts_policies.sql
-- Scope: apply payment_receipts RLS policies/grants only.
